<?php
session_start();
$createworkslot = new ownerUpdateWorkslotBoundary();
$createworkslot->displayUpdateWorkslot();

class ownerUpdateWorkslotBoundary {
    public function displayUpdateWorkslot() {
        ...
        echo '
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="../CSS/ownerupdateworkslotboundaryphp.css">
            </head>
            <body>
                <form action="../Controller/ownerUpdateWorkslotController.php?wsid=' . $workslotid . '&sid=' . $_SESSION['id'] . '" method="post">
                    <div id="createworkslotwordbox"><a id="createworkslotword">Update Workslot</a></div><br><br>';
                ...
                echo '
                    <label>ID: </label>
                    <input type="text" id="workslotid" name="workslotid" value="' . $workslotid . '" readonly>
                    ...
                    <a href="../Controller/manageWorkslotController.php?userid=' . $_SESSION['id'] .'" id="ca">BACK</a>
