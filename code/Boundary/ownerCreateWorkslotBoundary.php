<?php
session_start();
$createworkslot = new ownerCreateWorkslotBoundary();
$createworkslot->displayCreateWorkslot();

class ownerCreateWorkslotBoundary {
    public function displayCreateWorkslot() {
        $userid = $_GET['userid'];
        echo '
            <!DOCTYPE html>
            <html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="../CSS/ownercreateworkslotboundaryphp.css">
            </head>
            <body>
                <form action="../Controller/ownerCreateWorkslotController.php?userid=' . $_SESSION['id'] . '" method="post">
                    <div id="createworkslotwordbox"><a id="createworkslotword">Create Workslot</a></div><br><br>';
