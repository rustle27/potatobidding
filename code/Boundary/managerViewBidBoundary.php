<?php
session_start();
$viewBidBoundary = new viewBidBoundary();
$viewBidBoundary->displayViewBidBoundary();

class viewBidBoundary{
    public function displayViewBidBoundary(){
        if (isset($_SESSION['id'])){
            if ((isset($_GET['userData']))){
                ...
                <html>
                    ...
                    <body>
                        <div id="viewbidheaderbox"><a id="viewbidheader">Hi ' . $_SESSION['name'] . ', this is all the bids: </a></div>                        
                        <form id="usersearchbidform" action="../Controller/managerSearchBidController.php?userid=' . $_SESSION['id'] . '" method="post">
                                <h2>Search for bid: </h2>
                                <input type="text" name="search" placeholder="Search for some bid...">
                                        ...
                                        if ($role !== "system admin"){
                                            echo '<tr class="tablebody">
                                                ...
                                                if ($status !== "success" && $status !== "rejected"){
                                                    echo '<a href="../Controller/managerAcceptBidController.php?bidid=' . $id . '" class="acceptbtn">Accept</a>
                                                    <a href="../Controller/managerRejectBidController.php?bidid=' . $id . '" class="deletebtn">Reject</a>';
                                                }
                                                echo '
                                                </td>
                                            </tr>';
